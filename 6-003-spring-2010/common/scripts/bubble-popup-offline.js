...
'.zip' : 'File decompression software, such as <a href="http://www.pkware.com/">PKZIP</a>, <a href="http://www.winzip.com/">Winzip</a>, or <a href="http://www.stuffit.com/">StuffIt</a>, is required to open .zip files.',
};
    ...
    $.each(technicalRequirementsMap, function(key, value) {
        ...
        $('a').each(function(){
            ...
            if(typeof aHref != 'undefined'){
                ...
                var index = aHrefLowerCase.indexOf("rss.xml");
